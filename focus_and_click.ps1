...
if ($process) {
    ...
    # Click Configuration menu option at X=228, Y=530
    Write-Host "Clicking Configuration button at X=228, Y=530..."
    [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point(228, 530)
