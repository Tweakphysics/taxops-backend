...
if edge_win:
    ...
    # Click the WhatsApp Web tab
    print(f"Clicking WhatsApp Web tab at {WHATSAPP_TAB_COORD}...")
    pyautogui.click(WHATSAPP_TAB_COORD[0], WHATSAPP_TAB_COORD[1])
    time.sleep(2)
